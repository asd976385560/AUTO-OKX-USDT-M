...
STATE_DB = '<USER_HOME>/.openclaw/state/openclaw.sqlite'.replace('<USER_HOME>', str(__import__('pathlib').Path.home()))
OUT_DIR = Path(_public_project_path('reports', 'audit_snapshots'))
